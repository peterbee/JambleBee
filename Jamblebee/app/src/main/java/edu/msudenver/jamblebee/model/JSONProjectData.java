 ...
 */
public class JSONProjectData extends JSONObject implements ProjectData {
	 ...
	 */
	public JSONProjectData(String jsonInput) throws JSONException {
		super(jsonInput);
	}
	
	public JSONProjectData() {
		super();
        ...
        try {
            ...
            // we know that none of the keys are null because
            // we just created them so ignore this.
        }
		
	}
    public JSONProjectData(Map<String, Object> map) throws JSONException {
        super();
        long createdAt = System.currentTimeMillis();
